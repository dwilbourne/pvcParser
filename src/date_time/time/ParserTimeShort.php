...
class ParserTimeShort extends ParserTime implements ParserInterface
{
    ...
    /**
     * @function parse
     * @param string $localTimeDataString
     * @return bool
     */
    public function parse(string $localTimeDataString): bool
    {
        ...
        try {
            ...
            $carbon = Carbon::createFromFormat($this->pattern, $localTimeDataString, $tz);
        ...
        $msg = new InvalidTimeShortMsg($localTimeDataString);
        $this->setErrmsg($msg);
        return false;
    }
}
